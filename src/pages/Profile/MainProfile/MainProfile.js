...
const MainProfile = ({ user }) => {
  ...
  const { setIsFunctionEnabled } = useFunctionContext();

  useEffect(() => {
    fetch(`https://app-backend-7r7g.onrender.com/userpost?email=${user?.email}`)
      .then((res) => res.json())
      .then((data) => {
        setPosts(data);
      });
  ...
  const handleUploadCoverImage = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (url) {
          fetch(
            `https://app-backend-7r7g.onrender.com/userUpdates/${user?.email}`,
            {
              method: "PATCH",
              headers: {
            ...
            <div>
              ...
              <div className="avatar-img">
                ...
                <div className="infoContainer">
                  ...
                  >
                    <h4 style={{ fontSize: "18px" }}>Notifications:</h4>
                    <button
                      onClick={handleEnableFunction}
                      style={{
